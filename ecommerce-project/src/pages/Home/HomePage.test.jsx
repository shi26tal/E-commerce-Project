...
import { MemoryRouter } from "react-router"; //for testing
...
describe("HomePage Component", () => {
  ...
  it("displays the product correctly", async () => {
    ...
    const productContainers = await screen.findAllByTestId("product-container"); //wait until it find the element
